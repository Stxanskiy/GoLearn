...
func (h *Handler) RegisterRoutes(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Post("/admin/users/{id}/role", h.AdminUserSetRole)
			r.Post("/admin/users/{id}/block", h.AdminUserBlock)
			r.Post("/admin/users/{id}/delete", h.AdminUserDelete)
			r.Post("/admin/users/{id}/password", h.AdminUserResetPassword)
			...
			r.Post("/admin/module/{id}/move", h.AdminModuleMove)
			r.Post("/admin/module/{id}/publish", h.AdminModulePublish)
			...
			r.Post("/admin/lesson/{id}/publish", h.AdminLessonPublish)
			// Quiz questions
